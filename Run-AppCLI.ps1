...
$src_1 = "TestDataExamples\my-tests\test_1.txt"
$src_2 = "TestDataExamples\my-tests\test_2.txt"
$src_3 = "TestDataExamples\my-tests\test_3.txt"
$src_4 = "TestDataExamples\my-tests\test_4.txt"
