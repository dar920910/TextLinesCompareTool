//-----------------------------------------------------------------------
// <copyright file="LinesRepositoryTest.cs" company="Demo Projects Workshop">
...
public class LinesRepositoryTest
{
    ...
    public void PutContent_TestCase()
    {
        ...
        {
            Assert.That(
                actual: actual_content_0.ElementAt(0).Name,
                expression: Is.EqualTo(unique_source_name_0));

            Assert.That(
                actual: actual_content_1.ElementAt(0).Name,
                expression: Is.EqualTo(unique_source_name_0));
            Assert.That(
                actual: actual_content_1.ElementAt(1).Name,
                expression: Is.EqualTo(unique_source_name_1));

            Assert.That(
                actual: actual_content_2.ElementAt(0).Name,
                expression: Is.EqualTo(unique_source_name_0));
            Assert.That(
                actual: actual_content_2.ElementAt(1).Name,
                expression: Is.EqualTo(unique_source_name_1));
            Assert.That(
                actual: actual_content_2.ElementAt(2).Name,
