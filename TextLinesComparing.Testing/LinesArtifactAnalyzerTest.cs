...
public class LinesArtifactAnalyzerTest
{
    ...
    public void ExtractCommonLinesFromMapBasedSources_TestCase_1()
    {
        ...
        LinesStorage expected_common_map = new ();
        ...
        LinesStorage actual_common_map = LinesArtifactAnalyzer.ExtractCommonContent(map_1, map_2);
